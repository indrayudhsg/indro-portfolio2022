...
import sty from "./PlasmicButton.module.css"; // plasmic-import: aL3vzWiqlgO/css
import ChecksvgIcon from "./icons/PlasmicIcon__Checksvg"; // plasmic-import: Dj9-rT3pPVs/icon
import IconIcon from "./icons/PlasmicIcon__Icon"; // plasmic-import: WQNc4UVKkIc/icon
      ...
      {(
        ...
        >
          {p.renderPlasmicSlot({
            defaultContents: (
              <ChecksvgIcon
                className={classNames(projectcss.all, sty.svg__tVvHd)}
                role={"img"}
              />
            ),
      ...
      {(hasVariant(variants, "showEndIcon", "showEndIcon") ? true : false) ? (
        ...
        >
          {p.renderPlasmicSlot({
            defaultContents: (
              <IconIcon
                className={classNames(projectcss.all, sty.svg__tZMcA)}
                role={"img"}
              />
            ),
